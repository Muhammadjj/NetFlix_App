...
import 'package:netflix_app/Screen/Validation_Pages/Animated_Circle_Login_Ui/Signup_Page/animated_signup_ui_main.dart';
import 'package:netflix_app/Screen/netflix_main_Screen.dart';
import '../../../../Components/Colour_files/all_screen_color.dart';
import 'animated_login_widget.dart';



class AnimatedLoginScreenUI extends StatefulWidget {
  const AnimatedLoginScreenUI({super.key});

  @override
  State<AnimatedLoginScreenUI> createState() => _AnimatedLoginScreenUIState();
}

class _AnimatedLoginScreenUIState extends State<AnimatedLoginScreenUI> with TickerProviderStateMixin {
                  ...
                  // ** Login Text.
                     ...
                     SizedBox(height: heightMediaQuery*0.1,),
                      ...
                      onTap: () {
                        ...
                        builder: (context) =>const AnimatedSignUpPageUI(),));
                      },  
...
///** is (true) and Show This (NetFlixMainPage)
  void pressLoginButtonShowHomeScreen() {
   if (key.currentState!.validate()) {
   Navigator.of(context).pushReplacement(MaterialPageRoute(
     builder: (context) =>const NetFlixMainPage(),));
   } 
}
